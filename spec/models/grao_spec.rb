...
describe Grao do
  it 'responde se é do tipo arquivo' do
    Factory.build(:grao_arquivo).should be_arquivo
    Grao.new(tipo: 'outra coisa').should_not be_arquivo
  end

  it 'responde se é do tipo imagem' do
    Factory.build(:grao_imagem).should be_imagem
    Grao.new(tipo: 'outra coisa').should_not be_imagem
  end

  it 'informa seu tipo de modo humanizado' do
    Factory.build(:grao_imagem).tipo_humanizado.should == 'imagem'
    Factory.build(:grao_arquivo).tipo_humanizado.should == 'arquivo'
